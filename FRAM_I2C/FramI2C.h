...
#define MAX_NUMBER_BYTE_WRITE 128
...
private:
	...
	byte framI2CAddress = 0xA0; // Put this in globals
...
public:
        FramI2C(PinName sda, PinName scl,int freq, char slave_adr = MB85RC_I2C_ADDRESS);
                
	FramI2C(PinName sda, PinName scl, int freq, char slave_adr = MB85RC_I2C_ADDRESS, framPartNumber partNumber = MB85RC128A);
